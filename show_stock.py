...
if codes[sid]:
    ...
    if data_size:
        ...
        print('最近交易日交易量      : %11.2f' % np.array(data_frame['volumn'])[-1])
        print('最近交易日法人交易量  : %11.2f' % np.array(data_frame['juristic_volumn'])[-1])
        ...
        print('%-4d天法人交易總量    : %11.2f' % (data_size, sum(np.array(data_frame['juristic_volumn']))))
        print('')
        for dd in [60, 120, 240]:
            if period >= dd:
                ...
                print('%3d 天法人最大賣超量  : %11.2f' % (dd, get_period_days_data(data_frame, dd, min, 'juristic_volumn')))
                print('%3d 天法人最大買超量  : %11.2f' % (dd, get_period_days_data(data_frame, dd, max, 'juristic_volumn')))
                print('')
